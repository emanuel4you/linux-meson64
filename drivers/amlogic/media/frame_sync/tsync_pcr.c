...
u32 tsync_pcr_get_min_checkinpts(void)
{
	...
	if (last_checkin_vpts != 0xffffffff && last_checkin_apts != 0xffffffff)
		return min(last_checkin_vpts, last_checkin_apts);
	else if (last_checkin_apts != 0xffffffff)
		return last_checkin_apts;
	else if (last_checkin_vpts != 0xffffffff)
...
void tsync_pcr_pcrscr_set(void)
{
	...
	if (cur_pcr && cur_checkin_vpts != 0xffffffff && cur_checkin_apts != 0xffffffff) {
